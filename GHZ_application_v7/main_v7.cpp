                     ...
                     if(star1[i].sn==1 ||star1[i].sn==2)
                     {
                             ...
                             deathdate_sn=star1[i].death_date;
                              ...
                              wrap_flag=1;                              
								...
								//change_v4
								long int get1 = get_star_range_upper(i);
								
                              for (long int j=get_star_range_lower(i); j<=get1; j++)
                              {
                                  normal_ster_flag=0;
                                  wrap_ster_flag=0;
                                  birthdate_candidate=star1[j].birth_date;
         ...
         //*************************************                      
                          //   sn_debug << "\n1->2 "<<endl; 
                            // sn_debug << "star: "<<i<<" went SN"<<"  Cell: "<<star1[i].cell<<"  Subsection: "<<star1[i].subsection_z<<"  Column: "<<subsect_param_array[star1[i].cell]->subsection_xy;   
                               ...
                               //change_v4
                               long int get2 = get_star_range_upper_cell_right(star1[i].cell);
                               
                              for (long int k=get_star_range_lower_cell_right(star1[i].cell); k<=get2; k++)
                              {
                                  normal_ster_flag=0;
                                  wrap_ster_flag=0;
         ...
         for (long int l=1; l<=ptr_2_range; l++)
         {
                  ...
                  if(star2[l].sn==1 || star2[l].sn==2)
                  {
                       ...
                       sn_z=star2[l].z_coord;  
							...
							//change_v4
							long int get3 = get_star_range_upper_cell_left(star2[l].cell);
							
                           for (long int m=get_star_range_lower_cell_left(star2[l].cell); m<=get3; m++)
                              {
                                  normal_ster_flag=0;
                                  wrap_ster_flag=0;    
